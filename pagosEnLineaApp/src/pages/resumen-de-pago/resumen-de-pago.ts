...
export class ResumenDePagoPage {
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            this.httpRequest.get(Constantes.getCarritoUrl(token)).then((data : any) => {
              ...
              //this.order['description']= 'descipcion';
  ...
  vaciarCarrito(){
    ...
    .then(data => {
      ...
      for (let producto of this.productos){
        this.destallesCompra += producto.nombre + "; " +
                                producto.descripcion + "; " + 
                                "Cantidad " + producto.cantidad + "; " + 
                                producto.precio + "\n";
        this.eliminarProducto(producto.idP);
        
      }     
      
      this.venta['descripcion']= this.destallesCompra;
      console.log("detalles " + this.destallesCompra);
  ...
  async eliminarProducto(productoId) {
    await this.api.deleteProducto(productoId); 
